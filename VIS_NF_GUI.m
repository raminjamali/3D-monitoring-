function varargout = VIS_NF_GUI(varargin)
% VIS_NF_GUI M-file for VIS_NF_GUI.fig
%      VIS_NF_GUI, by itself, creates a new VIS_NF_GUI or raises the existing
%      singleton*.
%
%      H = VIS_NF_GUI returns the handle to a new VIS_NF_GUI or the handle to
%      the existing singleton*.
%
%      VIS_NF_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIS_NF_GUI.M with the given input arguments.
%
%      VIS_NF_GUI('Property','Value',...) creates a new VIS_NF_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before VIS_NF_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to VIS_NF_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help VIS_NF_GUI

% Last Modified by GUIDE v2.5 11-Oct-2015 19:01:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @VIS_NF_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @VIS_NF_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before VIS_NF_GUI is made visible.
function VIS_NF_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to VIS_NF_GUI (see VARARGIN)

% Choose default command line output for VIS_NF_GUI
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes VIS_NF_GUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = VIS_NF_GUI_OutputFcn(hObject, eventdata, handles) 
